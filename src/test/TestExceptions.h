...
TEST_EXCEPTION(ex_opEXCEEDED_WORK_LIMIT)
...
TEST_EXCEPTION(ex_LIQUIDITY_POOL_WITHDRAW_MALFORMED)
TEST_EXCEPTION(ex_LIQUIDITY_POOL_WITHDRAW_NO_TRUST)
TEST_EXCEPTION(ex_LIQUIDITY_POOL_WITHDRAW_UNDERFUNDED)
TEST_EXCEPTION(ex_LIQUIDITY_POOL_WITHDRAW_LINE_FULL)
TEST_EXCEPTION(ex_LIQUIDITY_POOL_WITHDRAW_UNDER_MINIMUM)
