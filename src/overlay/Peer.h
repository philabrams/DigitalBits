             ...
             public NonMovableOrCopyable
{
  ...
  public:
    ...
    {
        std::shared_ptr<DigitalBitsMessage const> mMessage;
  ...
  protected:
    ...
    class MsgCapacityTracker : private NonMovableOrCopyable
    {
        ...
        DigitalBitsMessage mMsg;

      public:
        MsgCapacityTracker(std::weak_ptr<Peer> peer, DigitalBitsMessage const& msg);
        ~MsgCapacityTracker();
        DigitalBitsMessage const& getMessage();
    ...
    void addMsgAndMaybeTrimQueue(std::shared_ptr<DigitalBitsMessage const> msg);
    ...
    void recvRawMessage(DigitalBitsMessage const& msg);
    void recvMessage(DigitalBitsMessage const& msg);
    void recvMessage(AuthenticatedMessage const& msg);
    void recvMessage(xdr::msg_ptr const& xdrBytes);

    virtual void recvError(DigitalBitsMessage const& msg);
    void updatePeerRecordAfterEcho();
    void updatePeerRecordAfterAuthentication();
    void recvAuth(DigitalBitsMessage const& msg);
    void recvDontHave(DigitalBitsMessage const& msg);
    void recvGetPeers(DigitalBitsMessage const& msg);
    void recvHello(Hello const& elo);
    void recvPeers(DigitalBitsMessage const& msg);
    void recvSurveyRequestMessage(DigitalBitsMessage const& msg);
    void recvSurveyResponseMessage(DigitalBitsMessage const& msg);
    void recvSendMore(DigitalBitsMessage const& msg);

    void recvGetTxSet(DigitalBitsMessage const& msg);
    void recvTxSet(DigitalBitsMessage const& msg);
    void recvTransaction(DigitalBitsMessage const& msg);
    void recvGetSCPQuorumSet(DigitalBitsMessage const& msg);
    void recvSCPQuorumSet(DigitalBitsMessage const& msg);
    void recvSCPMessage(DigitalBitsMessage const& msg);
    void recvGetSCPState(DigitalBitsMessage const& msg);
    ...
    void sendAuthenticatedMessage(DigitalBitsMessage const& msg);

    void beginMesssageProcessing(DigitalBitsMessage const& msg);
    void endMessageProcessing(DigitalBitsMessage const& msg);
  ...
  public:
    ...
    std::string msgSummary(DigitalBitsMessage const& digitalbitsMsg);
    ...
    void sendMessage(std::shared_ptr<DigitalBitsMessage const> msg,
                     bool log = true);
