...
class OverlayManagerImpl : public OverlayManager
{
  ...
  public:
    ...
    void recordMessageMetric(DigitalBitsMessage const& digitalbitsMsg,
                             Peer::pointer peer) override;

    void updateFloodRecord(DigitalBitsMessage const& oldMsg,
                           DigitalBitsMessage const& newMsg) override;
