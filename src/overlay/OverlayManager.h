 ...
 * `DigitalBitsMessage`, in the file src/xdr/DigitalBits-overlay.x
 *
 ...
 *
 * The `DigitalBitsMessage` union contains 3 logically distinct kinds of message:
 *
...
class OverlayManager
{
  public:
    ...
    virtual bool recvFloodedMsgID(DigitalBitsMessage const& msg, Peer::pointer peer,
                                  Hash& msgID) = 0;

    bool
    recvFloodedMsg(DigitalBitsMessage const& msg, Peer::pointer peer)
    {
        Hash msgID;
    ...
    virtual void recordMessageMetric(DigitalBitsMessage const& digitalbitsMsg,
                                     Peer::pointer peer) = 0;

    virtual void updateFloodRecord(DigitalBitsMessage const& oldMsg,
                                   DigitalBitsMessage const& newMsg) = 0;
