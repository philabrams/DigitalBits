...
{
Floodgate::FloodRecord::FloodRecord(DigitalBitsMessage const& msg, uint32_t ledger,
                                    Peer::pointer peer)
...
bool
Floodgate::addRecord(DigitalBitsMessage const& msg, Peer::pointer peer, Hash& index)
{
    ZoneScoped;
    index = xdrBlake2(msg);
    if (mShuttingDown)
...
void
Floodgate::updateRecord(DigitalBitsMessage const& oldMsg,
