...
std::vector<std::pair<uint32_t, CatchupConfiguration>> gCatchupRangeCases{
    ...
    {2, {63, maxCount, CatchupConfiguration::Mode::OFFLINE_BASIC}},
    ...
    {2, {64, maxCount, CatchupConfiguration::Mode::OFFLINE_BASIC}},
    ...
    {2, {191, maxCount, CatchupConfiguration::Mode::OFFLINE_BASIC}},
    ...
    {2, {320, maxCount, CatchupConfiguration::Mode::OFFLINE_BASIC}},
    ...
    for (auto const& test : gCatchupRangeCases)
    {
        ...
        CLOG_DEBUG(History, "Catchup configuration: {}", name);
        {
            ...
            if (range.applyBuckets())
            {
                ...
                REQUIRE(lastClosedLedger == LedgerManager::FEE_POOL_LEDGER_SEQ);
          ...
          "[catchup]")
{
    ...
    REQUIRE(crange1.getReplayCount() == 64);
