// Copyright 2014-2017 DigitalBits Development Foundation and contributors. Licensed
...
CatchupManagerImpl::startOnlineCatchup()
{
    ...
    auto hash = digitalbits::make_optional<Hash>(lcd.getTxSet()->previousLedgerHash());
