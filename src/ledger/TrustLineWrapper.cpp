...
TrustLineWrapper::NonIssuerImpl::addBalance(LedgerTxnHeader const& header,
                                            int64_t delta)
{
    return digitalbits::addBalance(header, mEntry, delta);
}
...
{
    return digitalbits::getBuyingLiabilities(header, mEntry);
}
...
TrustLineWrapper::NonIssuerImpl::getSellingLiabilities(
    LedgerTxnHeader const& header)
{
    return digitalbits::getSellingLiabilities(header, mEntry);
}
...
{
    return digitalbits::addBuyingLiabilities(header, mEntry, delta);
}
...
TrustLineWrapper::NonIssuerImpl::addSellingLiabilities(
    LedgerTxnHeader const& header, int64_t delta)
{
    return digitalbits::addSellingLiabilities(header, mEntry, delta);
}

bool
TrustLineWrapper::NonIssuerImpl::isAuthorized() const
{
    return digitalbits::isAuthorized(mEntry);
}

bool
TrustLineWrapper::NonIssuerImpl::isAuthorizedToMaintainLiabilities() const
{
    return digitalbits::isAuthorizedToMaintainLiabilities(mEntry);
}

bool
TrustLineWrapper::NonIssuerImpl::isClawbackEnabled() const
{
    return digitalbits::isClawbackEnabledOnTrustline(mEntry);
}
...
{
    return digitalbits::getAvailableBalance(header, mEntry);
}
...
TrustLineWrapper::NonIssuerImpl::getMaxAmountReceive(
    LedgerTxnHeader const& header) const
{
    return digitalbits::getMaxAmountReceive(header, mEntry);
}
