# Transactions
See [Concept documentation](https://www.digitalbits.io/developers/guides/concepts/transactions.html).

Anything that changes the ledger is called a _Transaction_.
Transactions have an arbitrary list of operations inside them.

See the "struct Transaction" definition in src/xdr/DigitalBits-transaction.x
...
## List of operations
See `src/xdr/DigitalBits-transaction.x` for a detailed list of all operations and results.
