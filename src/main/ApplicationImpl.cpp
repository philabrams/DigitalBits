...
#include <limits>
#define DIGITALBITS_CORE_REAL_TIMER_FOR_CERTAIN_NOT_JUST_VIRTUAL_TIME
...
ApplicationImpl::initialize(bool createNewDB)
{
    ...
    ConservationOfDigitalBits::registerInvariant(*this);
...
ApplicationImpl::getJsonInfo()
{
    ...
    info["build"] = DIGITALBITS_CORE_VERSION;
                             ...
                             optional<TimePoint> const& manualCloseTime)
{
    ...
    throw std::invalid_argument(
        "Set MANUAL_CLOSE=true in the digitalbits-core.cfg if you want to "
        "close every ledger manually. Otherwise, run digitalbits-core "
