          ...
          "[db][dbconnectionstring]")
{
    ...
    {
        REQUIRE(removePasswordFromConnectionString(
                    R"(postgresql://password=abc dbname=digitalbits)") ==
                R"(postgresql://password=******** dbname=digitalbits)");
    }

    SECTION("password is removed if second")
    {
        REQUIRE(removePasswordFromConnectionString(
                    R"(postgresql://dbname=digitalbits password=dbname)") ==
                R"(postgresql://dbname=digitalbits password=********)");
    }
    ...
    SECTION("quoted password is removed")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=digitalbits password='quoted password')") ==
            R"(postgresql://dbname=digitalbits password=********)");
    }
    ...
    SECTION("parameters after password remain unchanged")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=digitalbits password='quoted \\ password' performance='as fast as possible')") ==
            R"(postgresql://dbname=digitalbits password=******** performance='as fast as possible')");
    }
    ...
    SECTION("dbname can be quored")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname='digitalbits with spaces' password='quoted \\ password' performance='as fast as possible')") ==
            R"(postgresql://dbname='digitalbits with spaces' password=******** performance='as fast as possible')");
    }
    ...
    SECTION("Bug 2234 - barewords can be any non-whitespace")
    {
        ...
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=digitalbits user=digitalbits password=thisshouldbesecret host=/var/run/postgresql/)") ==
            R"(postgresql://dbname=digitalbits user=digitalbits password=******** host=/var/run/postgresql/)");
    }
}
